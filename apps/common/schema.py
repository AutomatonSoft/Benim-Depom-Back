...
class MarketplaceAutoSchema(AutoSchema):
    ...
    OPERATION_SUMMARIES = {
        ...
        ("GET", "/api/v1/catalog/types/"): "Получить типы товаров",
        ("GET", "/api/v1/catalog/product-types/{id}/"): "Получить тип товара",
        ("PATCH", "/api/v1/catalog/product-types/{id}/"): "Изменить тип товара",
        ("PUT", "/api/v1/catalog/product-types/{id}/"): "Заменить тип товара",
        ("DELETE", "/api/v1/catalog/product-types/{id}/"): "Удалить тип товара",
